...
export class EducationModal implements OnInit {
  ...
  constructor(fb:FormBuilder,private _service: MyService, private activeModal: NgbActiveModal, private countryPickerService: CountryPickerService) {
  ...
  public onSubmit(values:Object):void {
    ...
    this.activeModal.close();
     console.log("submitted");
      ...
      let data_hex = this.String2Hex(eduJSON);
